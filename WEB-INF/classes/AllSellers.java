...
@WebServlet("/AllSellers")

public class AllSellers extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException
	{
		...
		{}
			...
			String getMsg = "SELECT * from registration WHERE usertype='seller';";
 ...
 "<th>Rating</th>"+
  ...
  "</tr>");
			...
			while(rs.next()){
				pw.print("<form method='post' action='DeleteSeller'>" );
				pw.print("<tr>");
				
				pw.print("<td>"+rs.getString("username")+"</td>");
				pw.print("<td>"+rs.getString("email")+"</td>");
				//pw.print("<td>"+rs.getString("ratings")+"</td>");
