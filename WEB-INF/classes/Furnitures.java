...
public class Furnitures extends HttpServlet
{
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		sb.append("<div class='section-header text-center'><h2 class='title'>Furnitures</h2></div>");

		List<Product> electronics_list = new ArrayList<>();
		electronics_list.addAll(ProductsHashMap.getSofaList());
		electronics_list.addAll(ProductsHashMap.getBedsList());
		electronics_list.addAll(ProductsHashMap.getCupboardList());
		electronics_list.addAll(ProductsHashMap.getChairList());
		electronics_list.addAll(ProductsHashMap.getTableList());
