...
public class Miscellaneous extends HttpServlet
{
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		sb.append("<div class='section-header text-center'><h2 class='title'>Miscellaneous</h2></div>");

		List<Product> electronics_list = new ArrayList<>();
		electronics_list.addAll(ProductsHashMap.getMiscellaneousList());
