...
public class Electronics extends HttpServlet
{
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		electronics_list.addAll(ProductsHashMap.getTelevisionList());
		electronics_list.addAll(ProductsHashMap.getLaptopList());
		electronics_list.addAll(ProductsHashMap.getPhoneList());
		electronics_list.addAll(ProductsHashMap.getGameList());
		electronics_list.addAll(ProductsHashMap.getVaccuumCleanerList());
